...
df <- list(
    ...
    model_gpt3 = bind_rows(
        read_csv(
            "../tmp/healsl_rd1_rapid_gpt3_v2b.csv",
        ...
        read_csv(
            "../tmp/healsl_rd2_rapid_gpt3_v2b.csv",
            col_select = c("rowid", "cause1_icd10")
        ) %>% mutate(
            cause1_icd10 = str_sub(cause1_icd10, 1, 3),
            round = 2
    ...
    model_gpt4 = bind_rows(
        read_csv(
            "../tmp/healsl_rd1_rapid_gpt4_v1.csv",
            col_select = c("rowid", "round", "api_chat_icd")
        ),
        read_csv(
            "../tmp/healsl_rd2_rapid_gpt4_v1.csv",
            col_select = c("rowid", "round", "api_chat_icd")
        )
    ) %>% rename(gpt4_icd10 = api_chat_icd),
