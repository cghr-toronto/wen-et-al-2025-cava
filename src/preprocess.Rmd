...
# Print results
cat(paste0(
    "Physican ICD-10 Coded: ", phy_icd10,
    "\nPhysician ICD-10 Coded (Agree): ", phy_icd10_agree,
    "\nPhysican CGHR-10 Coded: ", phy_cghr10,
    "\nPhysician CGHR-10 Coded (Agree): ", phy_cghr10_agree
))
```
...
out_cgpt3_cghr10 <- out_cgpt3 %>% filter(
    !is.na(chatgpt3_cghr10) & !is.null(chatgpt3_cghr10)
)
out_cgpt3_cghr10_agree <- out_cgpt3_agree %>% filter(
    !is.na(chatgpt3_cghr10) & !is.null(chatgpt3_cghr10)
)
...
cat(paste0(
    ...
    "\nChatGPT-3.5 CGHR-10 Coded (Phy. ICD-10 Coded): ", out_cgpt3_cghr10 %>% nrow,
    "\nChatGPT-3.5 CGHR-10 Coded (Agree, Phy. ICD-10 Coded): ", out_cgpt3_cghr10_agree %>% nrow
))
```
...
out_cgpt4_cghr10 <- out_cgpt4 %>% filter(
    !is.na(chatgpt4_cghr10) & !is.null(chatgpt4_cghr10)
)
out_cgpt4_cghr10_agree <- out_cgpt4_agree %>% filter(
    !is.na(chatgpt4_cghr10) & !is.null(chatgpt4_cghr10)
)
...
cat(paste0(
    ...
    "\n\nAfter Conversion to CGHR-10\n---------------------------",
    "\nChatGPT-4 CGHR-10 Coded (Phy. ICD-10 Coded): ", out_cgpt4_cghr10 %>% nrow,
    "\nChatGPT-4 CGHR-10 Coded (Agree, Phy. ICD-10 Coded): ", out_cgpt4_cghr10_agree %>% nrow
))
```
...
out_iva5_cghr10 <- out_iva5_icd10 %>% filter(
    !is.na(interva5_cghr10) & !is.null(interva5_cghr10)
)
out_iva5_cghr10_agree <- out_iva5_icd10_agree %>% filter(
    !is.na(interva5_cghr10) & !is.null(interva5_cghr10)
)
...
cat(paste0(
    ...
    "\nInterVA-5 ICD-10 Coded (Phy. ICD-10 Coded): ", out_iva5 %>% nrow,
    "\nInterVA-5 ICD-10 Coded (Agree, Phy. ICD-10 Coded): ", out_iva5_agree %>% nrow,
    ...
    "\nInterVA-5 CGHR-10 Coded (Phy. ICD-10 Coded): ", out_iva5_cghr10 %>% nrow,
    "\nInterVA-5 CGHR-10 Coded (Agree, Phy. ICD-10 Coded): ", out_iva5_cghr10_agree %>% nrow
))
```
...
out_isva_cghr10 <- out_isva_icd10 %>% filter(
    !is.na(insilicova_cghr10) & !is.null(insilicova_cghr10)
)
out_isva_cghr10_agree <- out_isva_icd10_agree %>% filter(
    !is.na(insilicova_cghr10) & !is.null(insilicova_cghr10)
)
...
cat(paste0(
    ...
    "\nInSilicoVA ICD-10 Coded (Phy. ICD-10 Coded): ", out_isva %>% nrow,
    "\nInSilicoVA ICD-10 Coded (Agree, Phy. ICD-10 Coded): ", out_isva_agree %>% nrow,
    "\n\nAfter Conversion from WVA-2016 to ICD-10\n----------------------------------------",
    ...
    "\n\nAfter Conversion from ICD-10 to CGHR-10\n---------------------------------------",
    "\nInSilicoVA CGHR-10 Coded (Phy. ICD-10 Coded): ", out_isva_cghr10 %>% nrow,
    "\nInSilicoVA CGHR-10 Coded (Agree, Phy. ICD-10 Coded): ", out_isva_cghr10_agree %>% nrow
))
```
