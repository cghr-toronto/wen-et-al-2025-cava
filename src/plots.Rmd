...
plot_perf(
    ...
    calc_pccc,
    title = paste0(cod_adult, " Causes of Death for ", n_adult, " Adult Records")
) /
    plot_perf(
        df_long %>% filter(age == "child"),
        calc_pccc,
        title = paste0(cod_child, " Causes of Death for ", n_child, " Child Records")
    ) /
    plot_perf(
        df_long %>% filter(age == "neo"),
        calc_pccc,
        title = paste0(cod_neo, " Causes of Death for ", n_neo, " Neonatal Records")
    ) +
