...
plot_perf(
    ...
    y_title = paste0("Physician Agreed Records (n=", nrow(df), ")"),
    text_mid_size = 2.5,
    text_mid_vjust = 3
)
```
...
plot_perf(
    ...
    calc_pccc,
    group = "cod_name",
    title = paste0("(a) Adult, 12+ Years (n=", n_adult, ")"),
    x_title = "Partial Chance Corrected Concordance (PCCC)",
    ...
    plot_perf(
        ...
        calc_pccc,
        group = "cod_name",
        title = paste0("(b) Child, 28 Days to 11 Years (n=", n_child, ")"),
        x_title = "Partial Chance Corrected Concordance (PCCC)",
        y_title = "Cause of Death"
    ) /
    plot_perf(
        ...
        calc_pccc,
        group = "cod_name",
        title = paste0("(c) Neonatal, <28 Days (n=", n_child, ")"),
        x_title = "Partial Chance Corrected Concordance (PCCC)",
        y_title = "Cause of Death",
        text_mid_vjust = 3
    ) +
