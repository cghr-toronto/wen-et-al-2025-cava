...
plot_perf <- function(
        ...
        title = NULL,
        title_size = 10,
        x_title = "Partial Chance Corrected Concordance (PCCC) / R = PCCC Range",
        y_title = NULL,
        ...
        legend_margin = margin(c(-8, -2, -2, -2)),
        ...
    ) {
...
plot_perf_trend <- function(
    ...
    out <- ggplot(
        ...
        scale_color_manual(values = default_colors, labels = x_color_labels) +
        labs(
            title = title,
            x = x_title,
            y = y_title
...
fig_pccc_age <- plot_perf_trend(
    ...
    title = "Partial Chance Corrected Concordance (PCCC)",
    text_scale = 0.9
)
