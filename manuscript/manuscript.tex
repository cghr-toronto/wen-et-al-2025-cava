...
\textbf{Conclusion:} All models performed well at the population level, while GPT-3.5/4 and InSilicoVA performed well for some CODs. GPT models are unable to replace physician coding yet, but have made large improvements over InterVA-5, setting the foundation for assisting physicians with alternative diagnoses to reduce ill-defined codes and disagreement when coding VAs.
}
