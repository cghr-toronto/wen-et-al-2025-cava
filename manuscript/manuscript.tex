...
\title[Comparing ChatGPT-4 to Physicians for Assigning Causes of Death from Verbal Autopsy: A Case Study of 6942 Deaths in Sierra Leone from 2019-2022]{Comparing ChatGPT-4 to Physicians for Assigning Causes of Death from Verbal Autopsy: A Case Study of 6942 Deaths in Sierra Leone from 2019-2022}
...
For InterVA-5 and InSilicoVA, the standardized questionnaire data from the HEAL-SL EVA were first converted into 2016 World Health Organization (WHO) VA questionnaire revision 1.5.1 
\cite{dipasqualeReleaseODK20162016} Open Data Kit (ODK) format \cite{worldhealthorganizationODKVerbalAutopsy2022,nafundiODKCollectData2023} consisting of 526 variables, followed by further conversion into OpenVA format \cite{liOpenVAToolkitVerbal2023} consisting of 353 variables \cite{byassInterVA5UserGuide2020} using the \verb|pyCrossVA| Python package \cite{thomasPycrossvaPrepareData}. The \verb|Nsim| (number of iterations to run) parameter for InSilicoVA was set to 10,000, while the \verb|HIV| (level of prevalence of human immunodeficiency virus) and \verb|Malaria| (level of prevalence of Malaria) parameters were both set to \verb|'h'| (high). 

The 6942 physician agreed records were all converted into instructional text prompts for ChatGPT-3.5 and ChatGPT-4. Only 6897 of the 6942 physician agreed records were converted into OpenVA formatted records for InterVA-5 and InSilicoVA, where 45 records caused conversion errors and were skipped or removed.

\subsubsection{Output Data with CGHR-10 Codes}\label{methods-models-output}

Of the 6942 physician agreed records, ChatGPT-3.5 and ChatGPT-4 were able to assign CODs for 6932 and 6912 records respectively, while InterVA-5 and InSilicoVA both assigned CODs for 6833 records. All 6833 records with WHO VA 2016 v1.5 codes \cite{worldhealthorganizationVerbalAutopsyStandards2016} from InterVA-5 and InSilicoVA output were converted into ICD-10 codes. After all model outputs contained ICD-10 codes, they were further converted to CGHR-10 codes that generalized ICD-10 codes into 19, 10, and 7 categories for the adult (12 years or older), child (28 days to 11 years), and neonatal (under 28 days) age groups (see Additional file 2). The 6932 and 6912 records with ICD-10 codes from ChatGPT-3.5 and ChatGPT-4 output were converted into CGHR-10 codes, resulting in 6894 and 6857 records, where 38 and 55 records did not have matching CGHR-10 codes respectively. The 6833 records with ICD-10 codes from InterVA-5 and InSilicoVA output were also converted into CGHR-10 codes, resulting in and 6805 and 6729 records, where 28 and 104 records did not have matching CGHR-10 codes respectively. The 6942 physician agreed records with COD assignments in ICD-10 were also converted to CGHR-10 codes, which resulted in 6939 physician agreed records for comparison across physician and model assignments (three records in ICD-10 were not captured by the CGHR-10 ranges). The 6939 records contained 3826 adult, 2636 child, and 477 neonatal records.

\subsection{Performance Evaluation}\label{methods-eval}

The performance of four models, ChatGPT-3.5, ChatGPT-4, InterVA-5, and InSilicoVA, were evaluated with metrics on the population and individual level by comparing their CGHR-10 COD outputs to 6939 physician agreed records. Cause Specific Mortality Fraction (CSMF) accuracy was used to evaluate models on the population level, while Partial Chance Corrected Concordance (PCCC) was used to evaluate models on the individual level \cite{murrayRobustMetricsAssessing2011}. Records that were assigned a COD by physicians, but not by a model were considered to be an incorrect COD assignment by the model. CSMF accuracy and PCCC were calculated for each model by three age groups, and further into age ranges and cause of death for each age group.
