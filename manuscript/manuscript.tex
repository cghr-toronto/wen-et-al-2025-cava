...
\caption{Case study data sampling. VA records in Sierra Leone between 2019-2022 from the HEAL-SL study across territories. Sample deaths shown are records with physician assigned CODs only.}\label{fig-data-sampling}
\end{figure}
