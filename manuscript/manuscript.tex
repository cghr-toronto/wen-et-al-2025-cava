...
CSMF accuracy measures the performance of models at the population level, comparing distributions of CODs between the physicians and the models \cite{murrayRobustMetricsAssessing2011}. CSMF is the number of records $N_j$ for cause $j$ divided by the total number of records $N$ (Equation \ref{eq-csmf}).
