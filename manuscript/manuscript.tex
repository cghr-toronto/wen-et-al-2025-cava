...
Four computer models were used to predict COD for each of the 6939 physician agreed records: ChatGPT-3.5 \cite{brownLanguageModelsAre2020}, ChatGPT-4 \cite{openaiGPT4TechnicalReport2023a}, InterVA-5 \cite{byassIntegratedApproachProcessing2019}, and InSilicoVA \cite{mccormickProbabilisticCauseofDeathAssignment2016}. Each model required pre-processing of the 11,799 physician agreed records into input data, and standardization of output COD codes from models for performance evaluation as not all models produced ICD-10 codes.
...
\noindent For InterVA-5 and InSilicoVA, the standardized questionnaire data from the HEAL-SL EVA were first converted into 2016 World Health Organization (WHO) VA questionnaire revision 1.5.1 Open Data Kit (ODK) format \cite{nafundiODKCollectData2023}. The WHO revision 1.5.1 ODK data were further converted into OpenVA format \cite{liOpenVAToolkitVerbal2023} using the \verb|pyCrossVA| Python package \cite{thomasPycrossvaPrepareData}, and used as input for InterVA-5 and InSilicoVA. The input data were X generated prompts for ChatGPT-3.5 and ChatGPT-4, and X OpenVA formatted records for InterVA-5 and InSilicoVA.
