...
For GPT-3.5 and GPT-4, 6939 and 6935 text prompts were generated for each physician agreed record respectively, as input to instruct the models to assign CODs based on the open narratives. Two types of text prompts were used: user prompts and system prompts. User prompts were generated with a template involving replacing the placeholder \verb|<narrative>| using the free-text open narratives:
...
\botrule
\end{tabular}
\footnotetext{Note: Models sorted from highest to lowest PCCC. Improvements are from model below.}
\end{table}
