...
\noindent For InterVA-5 and InSilicoVA, the standardized questionnaire data from EVA were converted into into OpenVA format \citep{liOpenVAToolkitVerbal2023}, and fed into each model to produce COD assignments as WHOVA 2016 codes. All model outputs (ICD-10 for GPT-3.5/4 and WHOVA-2016 for InSilicoVA/InterVA-5) were converted to CGHR-10 codes to evaluate performances of models for COD assignment relative to physicians. See Appendix \ref{app-methods-model} for additional details regarding input parameters and code conversions for each model.
...
\subsection{Output Data and Code Conversion}\label{app-methods-output}
...
\section{Data Profile}\label{app-data}
