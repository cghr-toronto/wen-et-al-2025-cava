...
\begin{table}[h]
    ...
    \begin{tabular}{@{}llll@{}}
    \toprule
    \makecell{Leading Causes of Death\\($\sim$55\% of 68M deaths)\footnotemark[1]} & \makecell{Deaths\\(of 68M)\footnotemark[2]} & \makecell{Best\\Model(s)} & \makecell{PCCC} \\
    \midrule
    ...
    Kidney disease & 1.4M (2\%)  & GPT-3.5 & 0.92 (n=27)\footnotemark[4]\\
    Tuberculosis & 1.4M (2\%) & InSilicoVA & 0.71 (n=171)\\
    Hypertensive heart disease & 1.4M (2\%) & GPT-4 & 0.78 (n=107)\footnotemark[5]\\
    Cirrhosis of the liver & 1.3M (2\%) & GPT-3.5 & 0.78 (n=128)\footnotemark[6]\\ 
    ...
    Falls & 0.7M (1\%) & GPT-4 & 0.89 (n=492)\footnotemark[7]\\

    \botrule
    \end{tabular}
    \footnotetext[1]{Does not include COVID-19, alzheimer disease, other dementias, and self-harm. Trachea, bronchus, lung, colon, rectum, stomache, and breast cancers were generalized into cancers.}
    \footnotetext[2]{Total of $\sim$68 Million (M) deaths globally. Numbers are rounded.}
    \footnotetext[3]{Mean of chronic and acute respiratory infections.}
    \footnotetext[4]{Derived from diabetes mellitus.}
    \footnotetext[5]{Derived from other cardiovascular diseases.}
    \footnotetext[6]{Derived from liver and alcohol related diseases.}
    \footnotetext[7]{Mean of adult and child injuries.}
\end{table}
...
\begin{tabular*}{\textheight}{@{\extracolsep\fill}lllll}
    \toprule%
    Age Group  &  Cause of Death (COD)  &  Female  &  Male  &  Total  \\
    \midrule
...
\toprule%
    ...
    \midrule
        \makecell[l]{\\Adult (n=3826, 55.1\%, 18 CODs)\\Adult Female (n=1681, 43.9\%)\\Adult Male (n=2145, 56.1\%)}  &  10-14 Years  &  51 (37.8\%)  &  84 (62.2\%)  &  135 (3.5\%)  \\ 
        ...
        \makecell[l]{\\Child (n=2636, 38\%, 9 CODs)\\Child Female (n=1290, 48.9\%)\\Child Male (n=1346, 51.1\%)}  &  1-5 Months  &  146 (47.4\%)  &  162 (52.6\%)  &  308 (11.7\%)  \\ 
        &  6-11 Months  &  160 (50.8\%)  &  155 (49.2\%)  &  315 (11.9\%)  \\ 
        &  1-5 Years  &  822 (50.3\%)  &  811 (49.7\%)  &  1633 (61.9\%)  \\ 
        &  6-11 Years  &  162 (42.6\%)  &  218 (57.4\%)  &  380 (14.4\%)  \\ 
        \makecell[l]{\\Neonate (n=477, 6.9\%, 7 CODs)\\Neonate Female (n=227, 47.6\%)\\Neonate Male (n=250, 52.4\%)}  &  0-6 Days  &  184 (46.6\%)  &  211 (53.4\%)  &  395 (82.8\%)  \\ 
