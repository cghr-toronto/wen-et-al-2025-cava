...
\cite{dipasqualeReleaseODK20162016} Open Data Kit (ODK) format \cite{worldhealthorganizationODKVerbalAutopsy2022,nafundiODKCollectData2023}, followed by further conversion into OpenVA format \cite{liOpenVAToolkitVerbal2023} using the \verb|pyCrossVA| Python package \cite{thomasPycrossvaPrepareData}, and used as input for InterVA-5 and InSilicoVA. The \verb|Nsim| (number of iterations to run) parameter for InSilicoVA was set to 10,000, while the \verb|HIV| (level of prevalence of human immunodeficiency virus) and \verb|Malaria| (level of prevalence of Malaria) parameters were both set to \verb|'h'| (high). 
