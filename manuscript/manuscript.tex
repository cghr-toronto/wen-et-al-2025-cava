...
The following figures visualize the distribution of all physician agreed records by age groups (Figure \ref{fig-data-agesex}) and 5-year age ranges (Figure \ref{fig-data-agerange}).

\begin{figure}[h]
\centering
\includegraphics[width=1\textwidth]{fig-data-agesex.pdf}
\caption{Number of physician agreed VA records by adult, child, and neonatal age groups.}\label{fig-data-agesex}
\end{figure}

\newpage
\begin{figure}[h]
\centering
\includegraphics[width=0.9\textwidth]{fig-data-agerange.pdf}
\caption{Number of physician agreed VA records by 5-year age ranges.}\label{fig-data-agerange}
\end{figure}
...
The following figures visualize the distribution of adult physician agreed records by 5-year age ranges (Figure \ref{fig-data-agerange-adult}) and CGHR-10 cause of death code (Figure \ref{fig-data-cod-adult}).

\begin{figure}[h]
\centering
\includegraphics[width=0.9\textwidth]{fig-data-agerange-adult.pdf}
\caption{Number of physician agreed adult (12 years or older) VA records by 5-year age ranges.}\label{fig-data-agerange-adult}
\end{figure}

\newpage
\begin{figure}[h]
\centering
\includegraphics[width=0.75\textwidth]{fig-data-cod-adult.pdf}
\caption{Number of physician agreed adult (12 years or older) VA records by CGHR-10 cause of death code.}\label{fig-data-cod-adult}
\end{figure}

\newpage
\section{Child Physician Agreed Verbal Autopsy Records (28 Days to 11 Years)}\label{app-data-child}

The following figures visualize the distribution of child physician agreed records by 5-year age ranges (Figure \ref{fig-data-agerange-child}) and CGHR-10 cause of death code (Figure \ref{fig-data-cod-child}).

\begin{figure}[h]
\centering
\includegraphics[width=0.75\textwidth]{fig-data-agerange-child.pdf}
\caption{Number of physician agreed child (28 days to 11 years) VA records by 5-year age ranges.}\label{fig-data-agerange-child}
\end{figure}

\begin{figure}[h]
\centering
\includegraphics[width=0.9\textwidth]{fig-data-cod-child.pdf}
\caption{Number of physician agreed child (28 days to 11 years) VA records by CGHR-10 cause of death code.}\label{fig-data-cod-child}
\end{figure}

\newpage
\section{Neonatal Physician Agreed Verbal Autopsy Records (Under 28 Days)}\label{app-data-neo}

The following figures visualize the distribution of neonatal physician agreed records by 5-year age ranges (Figure \ref{fig-data-agerange-neo}) and CGHR-10 cause of death code (Figure \ref{fig-data-cod-neo}).

\begin{figure}[h]
\centering
\includegraphics[width=0.8\textwidth]{fig-data-agerange-neo.pdf}
\caption{Number of physician agreed neonatal (less than 28 days) VA records by 5-year age ranges.}\label{fig-data-agerange-neo}
\end{figure}

\begin{figure}[h]
\centering
\includegraphics[width=0.9\textwidth]{fig-data-cod-neo.pdf}
\caption{Number of physician agreed neonatal (less than 28 days) VA records by CGHR-10 cause of death code.}\label{fig-data-cod-neo}
\end{figure}
