...
The 6939 physician agreed records were relatively evenly distributed (approximately 40-57\% male and female) for each age group in terms of sex (Figure \ref{fig-data-agesex}) with the most records in the 1-5 year (n=1633, 24\%) age range, and the least records in the 10-14 year (n=135, 2\%) and 7-27 day (n=82, 1\%) age ranges (Figure \ref{fig-data-agerange}). Other 5-year age ranges within 0 days to 69 years were relatively evenly distributed with approximately 4-6\% of the 6939 records each. The 3826 adult records had most records in the 65-69 year (n=575, 15\%), and the least in the 10-14 year (n=135, 4\%) age ranges, while other age ranges were relatively evenly distributed at 7-9\% of all records (Figure \ref{fig-data-agerange-adult}). For adult CODs, Malaria (n=799, 21\%) had the highest number of adult records, and cancers (n=49, 1\%), diabetes mellitus (n=27, \textless 1\%), and suicide (n=3, \textless 1\%) had the lowest number adult of adult records, while other CODs had between 2-11\% of all adult records (Figure \ref{fig-data-cod-adult}). The 2636 child records had most records in the 1-5 year (n=1633, 62\%) age range while all other age ranges were relatively evenly distributed at 12-14\% of all records (Figure \ref{fig-data-agerange-child}). For child CODs, Malaria (n=1382, 52\%) and other infections (n=667, 25\%) had the highest number of child records, while nutritional deficiencies (n=11, \textless 1\%) and congenital anomalies (n=1, \textless 1\%) had the lowest number of records with all other CODs between 3-7\% of all child records. The 477 neonatal records only had two age ranges with most records in the 0-6 day (n=395, 83\%) age range and the rest in the 7-27 day (n=82, 17\%) age range (Figure \ref{fig-data-agerange-neo}). For neonatal CODs, stillbirth (n=172, 36\%) had the highest number of neonatal records, and ill-defined (n=23, 5\%), other (n=5, 1\%), and congenital anomalies (n=2, \textless 1\%) had very low number of records with the rest of the CODs between 15-22\% of all neonatal records (Figure \ref{fig-data-cod-neo}). See Appendices \ref{app-data} to \ref{app-data-neo} for a list of all figures presenting distribution of the 6939 physician agreed records.
...
\caption{Number of physician agreed verbal autopsy records by adult, child, and neonatal age groups in Sierra Leone from 2019 to 2022.}\label{fig-data-agesex}
\end{figure}
...
\caption{Number of physician agreed verbal autopsy records by 5-year age ranges in Sierra Leone from 2019 to 2022.}\label{fig-data-agerange}
\end{figure}
...
The following figures visualize the distribution of adult physician agreed records by 5-year age ranges (Figure \ref{fig-data-agerange-adult}) and CGHR-10 cause of death code in Sierra Leone from 2019 to 2022 (Figure \ref{fig-data-cod-adult}).

\begin{figure}[h]
\centering
\includegraphics[width=0.95\textwidth]{fig-data-agerange-adult.pdf}
\caption{Number of physician agreed adult (12 years or older) verbal autopsy records by 5-year age ranges in Sierra Leone from 2019 to 2022.}\label{fig-data-agerange-adult}
\end{figure}
...
\caption{Number of physician agreed adult (12 years or older) verbal autopsy records by CGHR-10 cause of death code in Sierra Leone from 2019 to 2022.}\label{fig-data-cod-adult}
\end{figure}

\newpage
\section{Child Physician Agreed Verbal Autopsy Records (28 Days to 11 Years)}\label{app-data-child}

The following figures visualize the distribution of child physician agreed records by 5-year age ranges (Figure \ref{fig-data-agerange-child}) and CGHR-10 cause of death code in Sierra Leone from 2019 to 2022 (Figure \ref{fig-data-cod-child}).

\begin{figure}[h]
\centering
\includegraphics[width=0.7\textwidth]{fig-data-agerange-child.pdf}
\caption{Number of physician agreed child (28 days to 11 years) verbal autopsy records by 5-year age ranges in Sierra Leone from 2019 to 2022.}\label{fig-data-agerange-child}
\end{figure}

\begin{figure}[h]
\centering
\includegraphics[width=0.85\textwidth]{fig-data-cod-child.pdf}
\caption{Number of physician agreed child (28 days to 11 years) verbal autopsy records by CGHR-10 cause of death code in Sierra Leone from 2019 to 2022.}\label{fig-data-cod-child}
\end{figure}

\newpage
\section{Neonatal Physician Agreed Verbal Autopsy Records (Under 28 Days)}\label{app-data-neo}

The following figures visualize the distribution of neonatal physician agreed records by 5-year age ranges (Figure \ref{fig-data-agerange-neo}) and CGHR-10 cause of death code in Sierra Leone from 2019 to 2022 (Figure \ref{fig-data-cod-neo}).

\begin{figure}[h]
\centering
\includegraphics[width=0.75\textwidth]{fig-data-agerange-neo.pdf}
\caption{Number of physician agreed neonatal (less than 28 days) verbal autopsy records by 5-year age ranges in Sierra Leone from 2019 to 2022.}\label{fig-data-agerange-neo}
\end{figure}

\begin{figure}[h]
\centering
\includegraphics[width=0.85\textwidth]{fig-data-cod-neo.pdf}
\caption{Number of physician agreed neonatal (less than 28 days) verbal autopsy records by CGHR-10 cause of death code in Sierra Leone from 2019 to 2022.}\label{fig-data-cod-neo}
\end{figure}
