...
Of the 6939 records, ChatGPT-4 had the highest PCCC overall and for the adult, child, and neonatal age groups. ChatGPT-3.5 performed better than InterVA-5 and InSilicoVA overall and for the adult and child age groups, but worse than InSilicoVA for the neonatal age group. Figure \ref{fig-perf-agegroup} shows the overall PCCC performance by age group with reference to the CSMF Accuracy.
