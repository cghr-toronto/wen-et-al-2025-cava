...
\caption{Model performance for adult records by five-year age range for assigning CGHR-10 CODs.}\label{fig-perf-agerange-adult}
\end{figure}
...
\caption{Model performance for child records by five-year age range for assigning CGHR-10 CODs.}\label{fig-perf-agerange-child}
\end{figure}
...
\begin{table}[!htbp]
    \caption{CGHR-10 COD assignment from GPT-4 for records coded as neonatal infections by physicians}\label{tab-misclass}%
    \begin{tabular}{@{}ll@{}}
    \toprule
