...
\caption{Model performance by age group.}\label{fig-perf-agegroup}
\end{figure}
...
\caption{Model performance for child records by COD.}\label{fig-perf-cod-child}
\end{figure}
...
\caption{Model performance for neonatal records by COD.}\label{fig-perf-cod-neo}
\end{figure}
...
\caption{Case study data sampling areas.}\label{fig-data-sampling}
\end{figure}
