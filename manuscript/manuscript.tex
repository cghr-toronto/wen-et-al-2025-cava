...
\noindent For InterVA-5 and InSilicoVA, the standardized questionnaire data from the HEAL-SL EVA were first converted into 2016 World Health Organization (WHO) VA questionnaire revision 1.5.1 Open Data Kit (ODK) format \cite{nafundiODKCollectData2023}, followed by further conversion into OpenVA format \cite{liOpenVAToolkitVerbal2023} using the \verb|pyCrossVA| Python package \cite{thomasPycrossvaPrepareData}, and used as input for InterVA-5 and InSilicoVA. The 6942 physician agreed records were all converted into generated text prompts as ChatGPT-3.5 and ChatGPT-4 inputs. Only 6897 of the 6942 physician agreed records were converted into OpenVA formatted records as InterVA-5 and InSilicoVA inputs as 45 records caused conversion errors and were skipped.
