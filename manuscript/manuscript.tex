...
\caption{Case study methods. Verbal autopsy records in Sierra Leone between 2019-2022 from the HEAL-SL study were filtered for physician agreed records, and pre-processed for COD assignment by ChatGPT-3.5, ChatGPT-4, InterVA-5 and InSilicoVA models. The output models were evaluated with CSMF Accuracy and PCCC overall, by age group, and by five-year age ranges for each age group.}\label{fig-methods}
\end{figure}
