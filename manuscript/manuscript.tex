...
\noindent For InterVA5 and InSilicoVA, the standardized questionnaire data from the HEAL-SL EVA were transformed into the 2016 World Health Organization (WHO) VA questionnaire revision 1.5.1 Open Data Kit (ODK) format \cite{nafundiODKCollectData2023}. The 2016 WHO VA revision 1.5.1 ODK data was further transformed into OpenVA format \cite{liOpenVAToolkitVerbal2023} using the \verb|pyCrossVA| Python package \cite{thomasPycrossvaPrepareData}.
